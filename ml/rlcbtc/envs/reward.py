...
# mean_delay_sec is fleet average lateness; scale so it competes with headway/violation terms.
DELAY_SCALE = 1.0 / 60.0
...
def compute_reward(
    ...
    *,
    ...
    reward = -(delay_sec * DELAY_SCALE) - HEADWAY_VAR_WEIGHT * headway_var - 10.0 * violations
