...
export function ControlPanel() {
    ...
    return (_jsxs("div", { style: {
            ...
            padding: '0 14px',
            zIndex: 50,
        }, children: [_jsx("span", { style: { color: COLORS.PANEL_TEXT, fontFamily: 'monospace', fontSize: 12, letterSpacing: '0.08em', marginRight: 8 }, children: "CBTC DISPATCH" }), _jsx("span", { style: { color: COLORS.PANEL_TEXT, fontFamily: 'monospace', fontSize: 12, letterSpacing: '0.06em' }, children: formatClock(now) }), _jsx("span", { style: { color: COLORS.PANEL_TEXT_DIM, fontFamily: 'monospace', fontSize: 11 }, children: formatDate(now) }), _jsxs("span", { title: "Simulated service time (starts 06:00)", style: { color: COLORS.PANEL_TEXT_DIM, fontFamily: 'monospace', fontSize: 11 }, children: ["SIM ", simClock] }), _jsx(EndpointDot, { ep: "topology", label: "/topology" }), _jsx(EndpointDot, { ep: "state", label: "/state" }), _jsx(EndpointDot, { ep: "commands", label: "/commands" }), mockMode && (_jsx("span", { style: { color: COLORS.SIGNAL_YELLOW, fontFamily: 'monospace', fontSize: 10, border: `1px solid ${COLORS.SIGNAL_YELLOW}`, padding: '1px 5px', borderRadius: 2 }, children: "MOCK" })), stale && (_jsx("span", { style: { color: COLORS.STALE_BANNER, fontFamily: 'monospace', fontSize: 11 }, children: "\u26A0 STALE DATA" })), commandError && (_jsxs("span", { onClick: clearCommandError, style: { color: COLORS.ERROR_BANNER, fontFamily: 'monospace', fontSize: 11, cursor: 'pointer', background: '#1a0000', padding: '2px 6px', borderRadius: 2 }, title: "Click to dismiss", children: ["\u2715 ", commandError] })), _jsx("div", { style: { flex: 1 } }), _jsx(Btn, { label: "INFO", onClick: () => setInfoOpen(true) }), _jsx(Btn, { label: showSafeZones ? 'SAFE ZONES ●' : 'SAFE ZONES ○', active: showSafeZones, onClick: toggleSafeZones }), _jsx(Btn, { label: showLabels ? 'LABELS ●' : 'LABELS ○', active: showLabels, onClick: toggleLabels }), _jsxs("span", { style: { color: COLORS.PANEL_TEXT_DIM, fontFamily: 'monospace', fontSize: 11 }, children: [runtime?.trains?.length ?? 0, " trains"] })] }));
}
