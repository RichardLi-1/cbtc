...
export function ConfigPanel({ open }) {
    ...
    return (_jsxs("div", { style: panelStyle, children: [_jsxs("div", { style: { color: COLORS.PANEL_TEXT, fontFamily: 'monospace', fontSize: 13, marginBottom: 12 }, children: ["\u2699 SIM CONFIG ", _jsx("span", { style: { color: COLORS.PANEL_TEXT_DIM, fontSize: 10 }, children: "(Ctrl+Shift+C)" })] }), section('RL TRAINING'), _jsx(Row, { label: "Experiment", children: _jsx("select", { value: configName, onChange: e => setConfigName(e.target.value), disabled: trainingRunning, style: {
                        flex: 1,
                        background: COLORS.BUTTON_BG,
                        color: COLORS.PANEL_TEXT,
                        border: `1px solid ${COLORS.PANEL_BORDER}`,
