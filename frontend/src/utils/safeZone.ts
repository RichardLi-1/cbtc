...
const PALETTES: Record<SlackTier, SafeZonePalette> = {
  nominal: {
    core: 'rgba(40, 160, 255, 0.80)',
    mid:  'rgba(30, 120, 255, 0.50)',
    edge: 'rgba(10,  80, 220, 0.25)',
    ring: 'rgba( 0,  40, 200, 0.00)',
  },
  caution: {
    core: 'rgba(255, 196,  0, 0.85)',
    mid:  'rgba(255, 152,  0, 0.55)',
    edge: 'rgba(230, 100,  0, 0.28)',
    ring: 'rgba(180,  70,  0, 0.00)',
  },
  danger: {
    core: 'rgba(255,  60,  50, 0.90)',
    mid:  'rgba(230,  30,  30, 0.60)',
    edge: 'rgba(180,  20,  20, 0.32)',
